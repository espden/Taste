...
namespace Taste.Pages.Customer.Home
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            MenuItemList = _unitOfWork.MenuItem.GetAll(includedProperties:"Category,FoodType");
            CategoryList = _unitOfWork.Category.GetAll(orderBy: q => q.OrderBy(c => c.DisplayOrder));
        }
    }
}